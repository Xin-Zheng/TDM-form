...
************************************************************************************************************/	
	...
	var theArcGISServerName = "http://"+theServerName+"/arcgis/rest/services/PIM_v2_7/MapServer";
   ...
   function showAddress(address) {
	...
	if (((parseInt(address.length) >= 8 && parseInt(address.length) <=13) && (address.substr(4,1)=="." || (address.substr(3,1)=="."))) //Old case
	  ...
	  || ((parseInt(address.length) == 9)  && (address.substr(0,2)=="MB" || address.substr(0,2)=="MA")) ) { // old misc permit
		...
		theSearchType = "Case";
		var theFieldList = ' "f9e05ab8-01ad-43dc-b94b-d4400884e54a"."parcel_nbr"  '
		//example: SELECT  "f9e05ab8-01ad-43dc-b94b-d4400884e54a"."parcel_nbr" from "f9e05ab8-01ad-43dc-b94b-d4400884e54a" where "record_id" ='2014-000020GPR'
		var queryString ='SELECT '+ theFieldList + ' from "f9e05ab8-01ad-43dc-b94b-d4400884e54a" where "record_id" = ' + "'" +address + "'"
		//prompt("",queryString)
		var data = {
			sql: queryString
		};
		$.ajax({
		//url: "http://civicdataprod.cloudapp.net/api/action/datastore_search_sql",   
...
function unMappedAccelaPlanning(theRecID) {
	...
	var theFieldList = ' "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25"."RECORD ID" '
	theFieldList +=', "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25"."APN" '
	theFieldList +=', "f9e05ab8-01ad-43dc-b94b-d4400884e54a"."parcel_nbr" '
	theFieldList +=', "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25"."DATE OPENED" '
	theFieldList +=', "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25"."ADDRESS" '
	theFieldList +=', "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25"."RECORD TYPE CATEGORY" '
	theFieldList +=', "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25"."RECORD STATUS DATE" '
	theFieldList +=', "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25"."STATUS" '
	theFieldList +=', "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25"."JOB VALUE" '
	theFieldList +=', "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25"."DATE CLOSED" '
	theFieldList +=', "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25"."DATE COMPLETED" '
	theFieldList +=', "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25"."RECORD NAME" '
	theFieldList +=', "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25"."RECORD TYPE" '
	theFieldList +=', "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25"."RECORD TYPE TYPE" '
	theFieldList +=', "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25"."DESCRIPTION" '
	theFieldList +=', "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25"."RECORD TYPE SUBTYPE" '
	theFieldList +=', "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25"."TEMPLATE ID" '
	theFieldList +=', "4d9454ba-fddd-4887-b71d-3b85e71ad635"."PARENT_ID" '
	theFieldList +=', "4d9454ba-fddd-4887-b71d-3b85e71ad635"."CHILD_ID" '
	
	if (!theParcelList) {
		theParcelList="'9'"
	}
	var queryString = 'SELECT ' + theFieldList + ' from  "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25" '
	queryString += 'LEFT JOIN "f9e05ab8-01ad-43dc-b94b-d4400884e54a" ON "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25"."RECORD ID" = "f9e05ab8-01ad-43dc-b94b-d4400884e54a"."record_id" '
	queryString += 'LEFT JOIN "4d9454ba-fddd-4887-b71d-3b85e71ad635" ON "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25"."RECORD ID" = "4d9454ba-fddd-4887-b71d-3b85e71ad635"."PARENT_ID" '
	...
	xmlhttp.onreadystatechange= function()
	  {
		if (xmlhttp.readyState==4 && xmlhttp.status==200) {
			...
			if (value.indexOf('>208.121.')>0 || value.indexOf('>166.137.186.110<')>0 || value.indexOf('>98.248.146.203<')>0 || value.indexOf('>24.7.113.168<')>0 || value.indexOf('>10.83.40.')>0 || value.indexOf('>10.83.41.')>0 || value.indexOf('>10.83.42.')>0 || value.indexOf('>10.83.43.')>0 || value.indexOf('>50.161.67.212<')>0) {
				city=true;
			}
			if (sitename!="SFFIND") {
...
function updateSFFindServicesHtml() {
	...
	if (isNeighborhood ||isDistrict) {
		...
		if (isLayerVisible("Public Schools")) {
			theSFFindServicesHtml += "<br><br><table width='100%'><tr><td align='left'><span class='reportSectionHead'>PUBLIC SCHOOLS: </span><input class='NoPrint' onclick='showHideMap( " + '"Public Schools"' + ");' title = 'Remove from map' alt='Remove from map' style= 'vertical-align: middle;' id='Public Schools' type='image' src = 'images/map-icon-on.png' /></td><td align='right'>&nbsp &nbsp</td></tr></table>"
		} else {
			theSFFindServicesHtml += "<br><br><table width='100%'><tr><td align='left'><span class='reportSectionHead'>PUBLIC SCHOOLS: </span><input class='NoPrint' onclick='showHideMap( " + '"Public Schools"'  + ");' title = 'Add to map' alt='Add to map' style= 'vertical-align: middle;' id='Public Schools' type='image' src = 'images/map-icon-off.png' /></td><td align='right'>&nbsp &nbsp</td></tr></table>"
		}
		temptheSFFindServicesHtml=""
		theNum=0
		for (var i = 0; i < idResults.length; i++) {
			var result = idResults[i];		
			if (dynamicMap2.layerInfos[result.layerId].name == "Public Schools") {
				theNum = theNum + 1
				if (theNum==1) {
					temptheSFFindServicesHtml +="<table><tr><td style='width:10px;'></td><td><table border=0 cellpadding=5px><tr><td style='width:250px;'><b>Name</b></td><td><b>Type</b></td><td><b>Phone Number</b></td></tr>"
				}
				temptheSFFindServicesHtml +="<tr><td style='width:250px;'>" +result.feature.attributes["SCHOOLNAME"] +"</td><td>"+ result.feature.attributes["SCHOOLTYPE"] +  "</td><td>"+result.feature.attributes["PHONE_1"] + "</td></tr>"
			}
		}
		if (theNum>0) {
			temptheSFFindServicesHtml += "</table></td></tr></table>"
		...
		theSFFindServicesHtml +="<a name='PublicSchools'></a>"
		if (isLayerVisible("Public Schools")) {
			theSFFindServicesHtml += "<br><br><table width='100%'><tr><td align='left'><span class='reportSectionHead'>PUBLIC SCHOOLS NEARBY: </span><input class='NoPrint' onclick='showHideMap( " + '"Public Schools"' + ");' title = 'Remove from map' alt='Remove from map' style= 'vertical-align: middle;' id='Public Schools' type='image' src = 'images/map-icon-on.png' /></td><td align='right'>&nbsp &nbsp</td></tr></table>"
		} else {
			theSFFindServicesHtml += "<br><br><table width='100%'><tr><td align='left'><span class='reportSectionHead'>PUBLIC SCHOOLS NEARBY: </span><input class='NoPrint' onclick='showHideMap( " + '"Public Schools"'  + ");' title = 'Add to map' alt='Add to map' style= 'vertical-align: middle;' id='Public Schools' type='image' src = 'images/map-icon-off.png' /></td><td align='right'>&nbsp &nbsp</td></tr></table>"
		}
		temptheSFFindServicesHtml=""
		theNum=0
		...
		for (var i = 0; i < idResults.length; i++) {
			var result = idResults[i];		
			if (result.layerName == "Public Schools 1 Mile Buffer") {
				if (in_array(result.feature.attributes["SCHOOLNAME"],thePublicSchoolstemp)) {
				} else {
					thePublicSchoolstemp.push(result.feature.attributes["SCHOOLNAME"])
					theNum = theNum + 1
					if (theNum==1) {
						temptheSFFindServicesHtml +="<table><tr><td style='width:10px;'></td><td><table border=0 cellpadding=5px><tr><td style='width:250px;'><b>Name</b></td><td><b>Type</b></td><td><b>Phone Number</b></td><td><b>Distance</b></td></tr>"
					}
					temptheSFFindServicesHtml +="<tr><td style='width:250px;'>" +result.feature.attributes["SCHOOLNAME"] +"</td><td>"+ result.feature.attributes["SCHOOLTYPE"] +  "</td><td>"+result.feature.attributes["PHONE_1"] + "</td><td>"+addCommas(result.feature.attributes["BUFF_DIST"]) +"ft</td></tr>"
				}
			}
		}
		if (theNum>0) {
...
// Now start the Preservation Report HTML
	...
	if (isLayerVisible("HRERs")) {
		theSurveyRatingsHtml += "<br><table width='100%'><tr><td align='left'><span class='reportSectionHead'>HISTORIC RESOURCE EVALUATION RESPONSES: </span><input class='NoPrint' onclick='showHideMap( " + '"HRERs"' + ");' title = 'Remove from map' alt='Remove from map' style= 'vertical-align: middle;' id='HRERs' type='image' src = 'images/map-icon-on.png' /></td><td align='right'>&nbsp &nbsp</td></tr></table>"
	} else {
		theSurveyRatingsHtml += "<br><table width='100%'><tr><td align='left'><span class='reportSectionHead'>HISTORIC RESOURCE EVALUATION RESPONSES: </span><input class='NoPrint' onclick='showHideMap( " + '"HRERs"' + ");' title = 'Add to map' alt='Add to map' style= 'vertical-align: middle;' id='HRERs' type='image' src = 'images/map-icon-off.png' /></td><td align='right'>&nbsp &nbsp</td></tr></table>"
	}
	...
	//	thrHRERDoc=""
	//	if (result.layerName == "HRER Decisions") {
	//			theHRERDec = result.feature.attributes["ACTION"] 
	//			lastHRERDec = theHRERDec
	//			signed = result.feature.attributes["ACTION_DATE"] 
	//			signedDate = new Date(signed)
	//			if (theHRERDec != undefined && theHRERDec=="HRER Determined Historic Resource") {
	//				theSurveyRatingsHtml = theSurveyRatingsHtml + "<table class='reportData'><tr><td style='width:15px'></td><td style='width:275px'>HRER Decision (" + signed + "):</td><td>Property is a Historic Resource</td></tr></table>"
	//				HR="true"
	//				anyHistoric=anyHistoric+1
	//			}
	//			if (theHRERDec != undefined && theHRERDec=="HRER Not Historic Resource") {
	//				theSurveyRatingsHtml = theSurveyRatingsHtml + "<table class='reportData'><tr><td style='width:15px'></td><td style='width:275px'>HRER Decision (" + signed + "):</td><td>Property is not a Historic Resource</td></tr></table>"
	//				HR="false"
	//			}
	...
	var theFieldList = ' "3b782388-dde8-4d2e-b9a5-664de728b514"."record_id" '
	theFieldList +=', "f9e05ab8-01ad-43dc-b94b-d4400884e54a"."parcel_nbr" '
	theFieldList +=', "3b782388-dde8-4d2e-b9a5-664de728b514"."rating_assessment" '
	theFieldList +=', "3b782388-dde8-4d2e-b9a5-664de728b514"."status_date" '
	theFieldList +=', "3b782388-dde8-4d2e-b9a5-664de728b514"."template_id" '
	
	if (!theParcelList) {
		theParcelList="'9'"
	}
	var queryString = 'SELECT ' + theFieldList + ' from "3b782388-dde8-4d2e-b9a5-664de728b514" INNER JOIN "f9e05ab8-01ad-43dc-b94b-d4400884e54a" ON  "3b782388-dde8-4d2e-b9a5-664de728b514"."record_id" = "f9e05ab8-01ad-43dc-b94b-d4400884e54a"."record_id" WHERE ("f9e05ab8-01ad-43dc-b94b-d4400884e54a"."parcel_nbr" in (' + theParcelList + ') )'
	//prompt("",queryString)
	var data = {
		sql: queryString
	};
		...
		success: function(data) {
			...
			if (recordTotal>0) {
				...
				for (i=0; i<data.result.records.length;i++) {
					...
					//if (tmpHRERRecID!=obj['record_id']&&tmpHRERDec!=obj['rating_assessment']&&tmpHRERDate!=obj['status_date']&&tmpHRERParcel!=obj['parcel_nbr']) {
					if (tmpHRERRecID!=obj['record_id'] && tmpHRERDec!=obj['rating_assessment'] && tmpHRERParcel!=obj['parcel_nbr'] && tmpHRERDate!=dateConvert(obj['status_date'])) {
						...
						//if ((theLoc=="City") && (dept=="PLANNING")) {
						//	theHRERLinks += "<a target='_blank' href='" + AALink +"'>View in AA*</a>"
						//}
								...
								if (theHistArray.length>1) {
									...
									if (signedDate > theLastSurveyDate) {
										...
										if (HR=="true") {
											...
											//theHistResOverall = 'A - Historic Resource Present'
										}
										if (HR=="false") {
											//alert("change to C");
											...
											//theHistResOverall = 'C - Not a Historic Resource'
										}
									} else {
										//alert("go with survey, don't need to change anything")
										//No need to change anything
		...
		var theTotalParcels=0
		 ...
		 for (var i = 0; i < idResults.length; i++) {
			...
			if (result.layerName == "Parcels") {
				...
				if (theParcelList=="") {
					theParcelList = "'"+result.feature.attributes["blklot"] +"'"
				} else {
					theParcelList += "," + "'"+result.feature.attributes["blklot"] +"'"
				}
			}
...
//go through the results array and look for the Zoning Districts that were found at the location.  Add these to the zoning report HTML.  
	...
	var tempURL = "http://" + theServerName + "/docs/Other/DB2_Nov2014_v2.pdf"
	theZoningHtml += "<br><table class='reportData'><tr><td style='width:15px'></td><td>An overview of Development Impact Fees can be found in the Planning Director's <a target='_blank' href='"+tempURL+"'>Bulletin No. 1</a></td></tr></table>"
	...
	//theFieldList +=', "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25"."RECORD TYPE CATEGORY" '
	theFieldList +=', "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25"."RECORD STATUS DATE" '
	theFieldList +=', "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25"."RECORD STATUS" '
	//theFieldList +=', "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25"."JOB VALUE" '
	theFieldList +=', "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25"."DATE CLOSED" '
	//theFieldList +=', "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25"."DATE COMPLETED" '
	theFieldList +=', "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25"."RECORD NAME" '
	...
	//theFieldList +=', "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25"."RECORD TYPE SUBTYPE" '
	theFieldList +=', "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25"."TEMPLATE ID" '
	theFieldList +=', "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25"."PLANNER NAME" '
	theFieldList +=', "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25"."PLANNER EMAIL" '
	theFieldList +=', "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25"."PLANNER PHONE" '
	//alert("1")
	//alert(theParcelList)
	if (!theParcelList) {
		theParcelList="'9'"
	}
	var queryString = 'SELECT ' + theFieldList + ' from  "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25" LEFT JOIN "f9e05ab8-01ad-43dc-b94b-d4400884e54a" ON "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25"."RECORD ID" = "f9e05ab8-01ad-43dc-b94b-d4400884e54a"."record_id" where ("parcel_nbr" in(' + theParcelList +  ') ) and "RECORD TYPE" like ' + "'Zoning Administrator%'" + ' order by "record_id" desc'
	//alert("2")
	//prompt("",queryString)
	...
	$.ajax({
		...
		error: function(xhr, status, error) {
			theHtmlZoningLetter=status + "<br><br>" + error + "<br><br>" + xhr.error
...
function updateProjectsHtml() {
	...
	queryString += 'LEFT JOIN "4d9454ba-fddd-4887-b71d-3b85e71ad635" ON "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25"."RECORD ID" = "4d9454ba-fddd-4887-b71d-3b85e71ad635"."PARENT_ID" '
	//queryString += 'where ("parcel_nbr" in(' + theParcelList +  ') OR "APN"  in(' + theParcelList + ' ) ) and "RECORD TYPE" <> ' + "'Misc. Permits-REF (MIS)'" + ' order by "record_id" desc, "CHILD_ID" asc'
	queryString += 'where ("parcel_nbr" in(' + theParcelList +  ')  ) '
	queryString +=  'and "RECORD TYPE" <> ' + "'Misc. Permits-REF (MIS)'" +  ' and "RECORD TYPE" <> ' + "'Enforcement (ENF)'" +  ' and "RECORD TYPE" not like ' + "'Zoning Administrator%'" + ' order by "DATE OPENED" desc,  "RECORD ID" desc, "PARENT_ID" desc, "CHILD_ID" asc '
	...
	$.ajax({
		...
		success: function(data) {
			...
			if (data.result.records.length==0) {
				...
				var tempDate = new Date() 
				var addedCases = new Array("99999")
				var lastParent=""
				theRecNum=0
					...
					if (tmpRecordID!=obj['RECORD ID'] || tmpOpened != obj['DATE OPENED'] || tmpParent!= obj['PARENT_ID']  || tmpChild!=obj['CHILD_ID']) {
						...
						if (isParent) {
							if (alreadyAddedThisOne==false) {
								...
								theHtml += "<tr><td style='width:15px'></td><td style='width:150px'><b>Planning App. No.: </b> </td><td><b>" + tmpRecordID+ "</b></td></tr>"
								var plannerName=obj['PLANNER NAME']
								var plannerEmail=obj['PLANNER EMAIL']
								var plannerPhone=obj['PLANNER PHONE']
								if (plannerName.length<2) {
...
function updateProjectsHtmlBAK() {
	//var queryString = 'SELECT * from "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25" WHERE "APN"=\'' +themapblklot + '\' order by "RECORD ID" desc'
	//var queryString = 'SELECT * from "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25" WHERE "APN" in (' +theParcelList + ') order by "RECORD ID" desc'
	//alert("here")
	var theFieldList = ' "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25"."RECORD ID" '
	theFieldList +=', "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25"."APN" '
	theFieldList +=', "f9e05ab8-01ad-43dc-b94b-d4400884e54a"."parcel_nbr" '
	...
	queryString += 'LEFT JOIN "f9e05ab8-01ad-43dc-b94b-d4400884e54a" ON "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25"."RECORD ID" = "f9e05ab8-01ad-43dc-b94b-d4400884e54a"."record_id" '
	queryString += 'LEFT JOIN "4d9454ba-fddd-4887-b71d-3b85e71ad635" ON "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25"."RECORD ID" = "4d9454ba-fddd-4887-b71d-3b85e71ad635"."PARENT_ID" '
	queryString += 'where ("parcel_nbr" in(' + theParcelList +  ') OR "APN"  in(' + theParcelList + ' ) ) and "RECORD TYPE" <> ' + "'Misc. Permits-REF (MIS)'" + ' order by "record_id" desc'
				...
				for (i=0; i<data.result.records.length;i++) {
					...
					if (obj['RECORD TYPE TYPE'] =="Project") {
						if (tmpRecordID!=obj['RECORD ID'] && tmpRecordTypeDetailed != obj['RECORD TYPE'] && tmpOpened != obj['DATE OPENED']) {
							...
							theHtml += "<tr><td style='width:15px'></td><td style='width:150px'><b>Record ID: </b> </td><td><b>" + obj['RECORD ID']+ "</b></td></tr>"
							...
							for (j=0; j<data.result.records.length;j++) {
								...
								if ((tmpPRJ==tmpCase) && (obj2['RECORD TYPE TYPE']!="Project") ) {
									if (tmpRecordID!=obj2['RECORD ID'] && tmpRecordTypeDetailed != obj2['RECORD TYPE'] && tmpOpened != obj2['DATE OPENED']) {
										...
										theHtml +="<table  class='reportData' style='width:100%; border-bottom: solid; border-width: 1px; border-color: #C8C8C8'>"
										theHtml += "<tr><td style='width:150px'><b>Record ID: </b> </td><td><b>" + obj2['RECORD ID']+ "</b></td></tr>"
										var theRecType = obj['RECORD TYPE']
										//if (!theRecType) { 
										//	theRecType = obj['RECORD TYPE TYPE'] 
										//}
...
function updateOtherPermitsHtml() {
	...
	var queryString = 'SELECT ' + theFieldList + ' from  "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25" LEFT JOIN "f9e05ab8-01ad-43dc-b94b-d4400884e54a" ON "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25"."RECORD ID" = "f9e05ab8-01ad-43dc-b94b-d4400884e54a"."record_id" where ("parcel_nbr" in(' + theParcelList +  ')  )and "RECORD TYPE" = ' + "'Misc. Permits-REF (MIS)'" + ' order by "record_id" desc'
	//alert("2")
			...
			if (data.result.records.length==0) {
				...
				for (i=0; i<data.result.records.length;i++) {
					...
					if (tmpRecordID!=obj['RECORD ID'] || tmpOpened != obj['DATE OPENED']) {
						...
						theHtmlMisc += "<tr><td style='width:15px'></td><td style='width:150px'><b>Record ID: </b> </td><td><b>" + obj['RECORD ID']+ "</b></td></tr>"
						var plannerName=obj['PLANNER NAME']
						var plannerEmail=obj['PLANNER EMAIL']
						var plannerPhone=obj['PLANNER PHONE']
...
function updateComplaintsHtml() {
	...
	var queryString = 'SELECT ' + theFieldList + ' from  "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25" LEFT JOIN "f9e05ab8-01ad-43dc-b94b-d4400884e54a" ON "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25"."RECORD ID" = "f9e05ab8-01ad-43dc-b94b-d4400884e54a"."record_id" where ("parcel_nbr" in(' + theParcelList +  ')  ) and "RECORD TYPE" = ' + "'Enforcement (ENF)'" + ' order by "record_id" desc'
	//prompt("",queryString)
	...
	$.ajax({
			...
			if (data.result.records.length==0) {
				...
				for (i=0; i<data.result.records.length;i++) {
					...
					if (tmpRecordID!=obj['RECORD ID'] || tmpOpened != obj['DATE OPENED']) {
						...
						theHtmlEnf += "<tr><td style='width:15px'></td><td style='width:150px'><b>Record ID: </b> </td><td><b>" + obj['RECORD ID']+ "</b></td></tr>"
						var plannerName=obj['PLANNER NAME']
						var plannerEmail=obj['PLANNER EMAIL']
						var plannerPhone=obj['PLANNER PHONE']
						if (plannerName.length<2) {
		...
		error: function(xhr, status, error) {
			theHtmlEnf=status + "<br><br>" + error + "<br><br>" + xhr.error
			theEnforcementHtml +="<table  class='reportData' style='width:100%; border-bottom: solid;'><tr><td style='width:15px'><td> Error connecting to Accela Permitting data!  If this problem persists please contact the system administrator.</td></tr></table>"
			document.getElementById('EnforcementReport').innerHTML = theEnforcementHtml	
		}
	});
...
//go through the results array and look for the Appeals records that were found at the location.  Add these to the Appeals report HTML.  
	...
	var queryString = 'SELECT   ' + theFieldList + ' from  "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25" LEFT JOIN "f9e05ab8-01ad-43dc-b94b-d4400884e54a" ON "ecdb4c6e-f48e-45be-b2de-f926d8d6cc25"."RECORD ID" = "f9e05ab8-01ad-43dc-b94b-d4400884e54a"."record_id" where ("parcel_nbr" in(' + theParcelList +  ') / ) and "RECORD TYPE" = ' + "'Appeals (APL)'" + ' order by "record_id" desc'
	//prompt("",queryString)
	theAppealsHtml +="<br><table class='reportData' width='100%'><tr><td style='width:10px'></td><td>Planning Projects, Building Permits and Zoning Determinations appealed to the San Francisco <a target='_blank' alt='Board of Appeals' href='http://www.sfgov3.org/index.aspx?page=763'>Board of Appeals</a>.</td></tr></table>"
	theAppealsHtml +="<div class='NoPrint'><br><br><table width='100%'><tr><td align='left'><span class='reportSectionHead'>ON THIS PAGE: </span></td></tr></table>"
	theAppealsHtml +="<table class='reportData' width='100%'><tr><td style='width:20px'></td><td><a href='#BookmarkBoardOfAppeals'>Appeals</a></td></tr></table>"
