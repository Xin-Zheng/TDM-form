...
Author: 	Xin Zheng (Xin.Zheng@sfgov.org) updated the system which created by
			Paul Sohn (paul.sohn@sfgov.org) using PIM platform built by Mike Wynne (mike.wynne@sfgov.org)
...
var beta_disclaimer = 	"<table class='NoPrint' width='100%'><br><tr><td style='width:10px'></td><td><i>" +
	...
	var theServerName = "54.83.57.240";
	...
	function ViewLegend() {
    	...
    	var dialogBox
      	...
      	require(["dijit/Dialog"], function(Dialog) {
      		divnamenum = new Date().getTime();	
      		divname = divnamenum.toString();
          	
          	var htmlFragment = '<div id='+divname+' style="width:300px; height:400px; border: 1px solid #A8A8A8; overflow: auto;"></div>';
